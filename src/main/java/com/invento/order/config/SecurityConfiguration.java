...
import com.invento.order.filter.CsrfCookieFilter;
import com.invento.order.filter.JWTTokenValidatorFilter;
...
public class SecurityConfiguration {
	...
	SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
		...
		http
			...
			.requestMatchers("/order/getStatusValues").permitAll()					
